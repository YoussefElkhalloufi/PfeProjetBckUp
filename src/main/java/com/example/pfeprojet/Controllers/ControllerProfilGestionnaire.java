...
public class ControllerProfilGestionnaire {
    ...
    Entreprise e = ControllerDashboardGestionnaire.getEntreprise();


    @FXML
    void dashboardGestionnaire(ActionEvent event) throws IOException {
    ...
    void update(ActionEvent event) {
        ...
        Gestionnaire gestio = ControllerDashboardGestionnaire.gestio ;
        if(e.updatePersonnel("gestionnaires", gestio.getNom(), gestio.getPrenom(), mail, pwd)){
