...
public class ControllerProfilResponsable {
    ...
    Entreprise e = ControllerDashboardResponsable.getEntreprise();


    @FXML
    void dashboardResponsable(ActionEvent event) throws IOException {
    ...
    void update(ActionEvent event) {
        ...
        Responsable respo = ControllerDashboardResponsable.respo ;
        if(e.updatePersonnel("responsables", respo.getNom(), respo.getPrenom(), mail, pwd)){
