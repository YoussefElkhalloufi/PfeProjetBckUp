...
public class testController {
    ...
    public void onMouseEntered(javafx.scene.input.MouseEvent event) { ms.onMouseEntered(event, ExitButton1);}

    public void onMouseExited(javafx.scene.input.MouseEvent event) {
        ms.onMouseExited(event, ExitButton1);
    }


    public void onMouseEntered2(javafx.scene.input.MouseEvent event) {
        ms.onMouseEntered2(event, NextButton1);
    }

    public void onMouseExited2(javafx.scene.input.MouseEvent event) {
        ms.onMouseExited2(event, NextButton1);
    }


    public void onMouseEntered3(javafx.scene.input.MouseEvent event) { ms.onMouseEntered(event, ExitButton2);}

    public void onMouseExited3(javafx.scene.input.MouseEvent event) {
        ms.onMouseExited(event, ExitButton2);
    }


    public void onMouseEntered4(javafx.scene.input.MouseEvent event) {
        ms.onMouseEntered2(event, NextButton2);
    }

    public void onMouseExited4(javafx.scene.input.MouseEvent event) {
        ms.onMouseExited2(event, NextButton2);
    }
